      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Have questions about our artworks or interested in commissioning a piece? 
            We'd love to hear from you. Reach out to us using the form below or visit our gallery.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="h-96 md:h-auto rounded-xl overflow-hidden shadow-lg">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241317.11609823277!2d72.74075142245006!3d19.08205172359968!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1651255864673!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
